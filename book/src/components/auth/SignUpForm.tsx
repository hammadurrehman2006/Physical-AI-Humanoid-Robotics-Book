...
const SignUpForm: React.FC<SignUpFormProps> = ({ onSuccess }) => {
  ...
  const [formData, setFormData] = useState({
    name: '', // Added name back to state as it is used in the form
    email: '',
    password: '',
    confirmPassword: '',
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await signUp({
        ...
        // Note: 'name' is not currently sent to backend based on previous client.ts, 
        // but kept in form for UI completeness or future use.
      });
