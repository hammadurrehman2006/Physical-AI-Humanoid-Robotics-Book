...
(async () => {
  ...
  try {
    ...
    if (htmlLang === 'ur') {
      ...
      console.log(`❌ HTML lang attribute is "${htmlLang}", expected "ur"`);
    }
    ...
    if (introPageLang === 'ur' && (introPageDir === 'ltr' || introPageComputedDir === 'ltr')) {
    ...
    const textElements = await page.$$('.docItemContainer div, .markdown p, .navbar__brand, .footer__title');
